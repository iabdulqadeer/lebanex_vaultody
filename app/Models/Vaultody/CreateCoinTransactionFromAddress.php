...
class CreateCoinTransactionFromAddress extends VaultodyAbstract {

    protected static $method = 'POST';
    protected static $url = '/wallet-as-a-service/wallets/{walletId}/{blockchain}/{network}/addresses/{address}/transaction-requests';
